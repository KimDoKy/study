...
class Villain(Entity):
    ...
    malevolence_factor = models.PositiveSmallIntegerField(
            help_text="How malevolent this villanin is?"
            )
    power_fator = models.PositiveSmallIntegerField(
            help_text="How powerfull this villain is?"
            )

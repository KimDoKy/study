...
def get_data_from_excel(filename):
    '''
    get_data_from_excel(file) -> {'name1':'score1', 'name2':'score2',..}
    엑셀 파일에서 데이터를 가져옵니다.
...
def evaluateClass(avrg, total_avrg, std_dev, sd):
    '''
    evaluateClass(avrg, total_avrg, std_dev, ad) -> None
    avrg : 반 성적 평균
